...
nix develop .#record --command node scripts/build-showcase.mjs \
  ...
  --clip "Structural build order|recordings/shorts-mode/test-hogwarts-structural.mp4|1|5" \
  --clip "BIGGER: 13K-block fire vs ice dragons|recordings/shorts-mode/dragons-fighting-v2.mp4|3|5" \
